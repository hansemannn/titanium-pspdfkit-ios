...
@objc(TiPspdfkitExampleProxy)
class TiPspdfkitExampleProxy: TiProxy {

  override func _init(withPageContext context: TiEvaluator!) -> TiPspdfkitExampleProxy! {
